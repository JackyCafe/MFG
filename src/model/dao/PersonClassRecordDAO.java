...
public class PersonClassRecordDAO extends DAO implements IDAO<PersonClassRecordBean> {
	...
	public static void main(String[] args) {
		...
		try {
			...
			pcibBean = personClassInfoDAO.select(2);
			bean = new PersonClassRecordBean(pcibBean, new Date(), null, null);
			personClassRecordDAO.insert(bean);
 			pcibBean.getPersonClassRecords().add(bean); 			
